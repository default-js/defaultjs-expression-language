...
/**
 * SPECIFICATION.md 9.2 - that each implementation registers itself on import, asked of every
 * executer.
 *
 ...
 * `syntax` (9.4) for the assignment this file used to carry.
 */

for (const { name: executer } of EXECUTERS) {

	describe(`Specification 9.2 - the implementation registers itself [${executer}]`, () => {
